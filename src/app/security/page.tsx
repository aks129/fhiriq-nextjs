  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-fg mb-4">Information Security Policy</h1>
        <p className="text-fg-2 mb-8">Last Updated: January 17, 2025</p>

        <div className="prose prose-lg max-w-none">
          {/* Executive Summary */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">Executive Summary</h2>
          ...
          {/* Purpose and Scope */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">1. Purpose and Scope</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">1.1 Purpose</h3>
            <p className="text-fg-2 mb-4">
              The purpose of this Information Security Policy is to:
            </p>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">1.2 Scope</h3>
            <p className="text-fg-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">2. Information Security Governance</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">2.1 Security Roles and Responsibilities</h3>
            <div className="bg-bg-2 p-6 rounded-lg mb-4">
              <p className="text-fg-2 mb-3"><strong>Executive Management:</strong></p>
              <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-1">
              ...
              <p className="text-fg-2 mb-3"><strong>Security Officer:</strong></p>
              <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-1">
              ...
              <p className="text-fg-2 mb-3"><strong>All Employees:</strong></p>
              <ul className="list-disc pl-6 text-fg-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">2.2 Policy Review and Updates</h3>
            <p className="text-fg-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">3. Information Classification and Handling</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">3.1 Data Classification</h3>
            <div className="space-y-4 mb-4">
              <div className="border-l-4 border-line-2 pl-4">
                <p className="font-semibold text-fg">Critical/Confidential</p>
                <p className="text-fg-2 text-sm">Protected Health Information (PHI), client data, financial records, authentication credentials, proprietary business information</p>
              </div>

              <div className="border-l-4 border-line-2 pl-4">
                <p className="font-semibold text-fg">Internal Use Only</p>
                <p className="text-fg-2 text-sm">Internal communications, project documentation, employee information, non-public technical specifications</p>
              </div>

              <div className="border-l-4 border-line-2 pl-4">
                <p className="font-semibold text-fg">Public</p>
                <p className="text-fg-2 text-sm">Marketing materials, published documentation, public website content, press releases</p>
              </div>
            </div>

            <h3 className="text-xl font-semibold text-fg mb-3">3.2 Data Handling Requirements</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Access Control */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">4. Access Control and Authentication</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">4.1 User Access Management</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">4.2 Password Requirements</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">4.3 Privileged Access Management</h3>
            <p className="text-fg-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">5. Network and System Security</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">5.1 Network Security Controls</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">5.2 Endpoint Security</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">5.3 Cloud and Third-Party Services</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Data Protection */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">6. Data Protection and Privacy</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">6.1 Healthcare Data Protection</h3>
            <p className="text-fg-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">6.2 Data Backup and Recovery</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">6.3 Data Retention and Disposal</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">7. Application and Development Security</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">7.1 Secure Development Practices</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">7.2 FHIR-Specific Security</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">7.3 Production Environment Security</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Security Monitoring */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">8. Security Monitoring and Logging</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">8.1 Logging Requirements</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">8.2 Security Monitoring</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Incident Response */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">9. Incident Response and Management</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">9.1 Incident Response Process</h3>
            <p className="text-fg-2 mb-4">
              FHIR IQ maintains a formal incident response plan with the following phases:
            </p>
            <ol className="list-decimal pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">9.2 Incident Severity Classification</h3>
            <div className="space-y-3 mb-4">
              <div className="bg-bg-2 p-4 rounded border-l-4 border-line-2">
                <p className="font-semibold text-fg">Critical (P1)</p>
                <p className="text-fg-2 text-sm">PHI breach, system-wide outage, ransomware - Response within 1 hour</p>
              </div>

              <div className="bg-bg-2 p-4 rounded border-l-4 border-line-2">
                <p className="font-semibold text-fg">High (P2)</p>
                <p className="text-fg-2 text-sm">Significant service degradation, potential data exposure - Response within 4 hours</p>
              </div>

              <div className="bg-bg-2 p-4 rounded border-l-4 border-line-2">
                <p className="font-semibold text-fg">Medium (P3)</p>
                <p className="text-fg-2 text-sm">Minor service impact, security vulnerability identified - Response within 24 hours</p>
              </div>

              <div className="bg-bg-2 p-4 rounded border-l-4 border-fg">
                <p className="font-semibold text-fg">Low (P4)</p>
                <p className="text-fg-2 text-sm">Minimal impact, policy violation - Response within 72 hours</p>
              </div>
            </div>

            <h3 className="text-xl font-semibold text-fg mb-3">9.3 Breach Notification</h3>
            <p className="text-fg-2 mb-4">
          ...
          {/* Vendor Management */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">10. Third-Party and Vendor Management</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">10.1 Vendor Security Assessment</h3>
            <p className="text-fg-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">10.2 Vendor Access Control</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Physical Security */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">11. Physical Security</h2>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Business Continuity */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">12. Business Continuity and Disaster Recovery</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">12.1 Business Continuity Planning</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">12.2 Testing and Maintenance</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">13. Security Training and Awareness</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">13.1 Training Requirements</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">13.2 Security Awareness Program</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Compliance */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">14. Compliance and Audit</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">14.1 Regulatory Compliance</h3>
            <p className="text-fg-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">14.2 Security Assessments</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">14.3 Documentation and Records</h3>
            <ul className="list-disc pl-6 text-fg-2 mb-4 space-y-2">
          ...
          {/* Policy Violations */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">15. Policy Violations and Enforcement</h2>

            <h3 className="text-xl font-semibold text-fg mb-3">15.1 Consequences</h3>
            <p className="text-fg-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-fg mb-3">15.2 Reporting Violations</h3>
            <p className="text-fg-2">
          ...
          {/* Contact Information */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">16. Contact Information</h2>
            <p className="text-fg-2 mb-4">
              For questions about this Information Security Policy or to report security concerns:
            </p>
            <div className="bg-bg-2 p-6 rounded-lg">
              <p className="text-fg font-semibold mb-2">FHIR IQ Security Team</p>
              <p className="text-fg-2">Email: <a href="mailto:security@fhiriq.com" className="text-primary-blue hover:underline">security@fhiriq.com</a></p>
              <p className="text-fg-2">General Contact: <a href="mailto:gene@fhiriq.com" className="text-primary-blue hover:underline">gene@fhiriq.com</a></p>
              <p className="text-fg-2">Website: <a href="https://www.fhiriq.com" className="text-primary-blue hover:underline">www.fhiriq.com</a></p>
          ...
          {/* Acknowledgment */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-fg mb-4">17. Policy Acknowledgment</h2>
            <p className="text-fg-2 mb-4">
      ...
      {/* Footer */}
      <footer className="bg-bg-2 text-fg py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-fg-3">
                ...
                <li><Link href="/security" className="hover:text-fg">Security Policy</Link></li>
