        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              <Link href="/products" className="text-fg font-semibold">
                Products
              </Link>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Developer Licenses */}
            <div className="bg-bg border border-line rounded-lg p-6 shadow-lg">
              <h3 className="text-2xl font-bold mb-4 text-fg">Developer Licenses</h3>
              <p className="text-fg-2 mb-4">
                Professional FHIR development tools with advanced validation and code generation.
              </p>
              <ul className="text-sm text-fg-2 mb-6 space-y-2">
                <li>• Advanced FHIR validation</li>
                <li>• Premium code generators</li>
                <li>• Multi-user support</li>
                <li>• Priority support</li>
              </ul>
              <div className="text-2xl font-bold text-fg mb-4">Starting at $299/year</div>
              <button className="w-full bg-fg text-bg py-2 px-4 rounded hover:bg-fg">
                View Details
              </button>
            </div>
            ...
            {/* Training Programs */}
            <div className="bg-bg border border-line rounded-lg p-6 shadow-lg">
              <h3 className="text-2xl font-bold mb-4 text-fg">FHIR Training</h3>
              <p className="text-fg-2 mb-4">
              ...
              <div className="text-2xl font-bold text-fg mb-4">Starting at $1,299</div>
              <button className="w-full bg-fg text-bg py-2 px-4 rounded hover:bg-fg">
                View Training
              </button>
            </div>
            ...
            {/* Consulting Services */}
            <div className="bg-bg border border-line rounded-lg p-6 shadow-lg">
              <h3 className="text-2xl font-bold mb-4 text-fg">Consulting</h3>
              <p className="text-fg-2 mb-4">
              ...
              <div className="text-2xl font-bold text-fg mb-4">Custom Pricing</div>
              <button className="w-full bg-fg text-bg py-2 px-4 rounded hover:bg-fg">
                Get Quote
              </button>
            </div>
