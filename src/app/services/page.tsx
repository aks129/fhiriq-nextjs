...
export default function Services() {
  return (
    <div className="min-h-screen bg-bg">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-primary-navy via-primary-blue to-accent-purple text-fg py-20">
        <div className="max-w-7xl mx-auto px-4">
      ...
      <section className="py-16 bg-bg">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-bg-2 rounded-xl p-8">
              ...
              <h3 className="text-xl font-bold mb-3 text-fg">Strategic Planning</h3>
            ...
            <div className="bg-bg-2 rounded-xl p-8">
              ...
              <h3 className="text-xl font-bold mb-3 text-fg">Hands-On Implementation</h3>
              <p className="text-fg-2 mb-4">
            ...
            <div className="bg-bg-2 rounded-xl p-8">
              ...
              <h3 className="text-xl font-bold mb-3 text-fg">Training & Enablement</h3>
              <p className="text-fg-2 mb-4">
      ...
      {/* Services Grid */}
      <section id="services" className="py-16 bg-bg-2">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-fg">Service Offerings</h2>
            <p className="text-xl text-fg-2 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Strategic Advisory */}
            <div className="bg-bg rounded-xl p-8 shadow-sm hover:shadow-lg transition">
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-2xl font-bold text-fg">Strategic Advisory</h3>
                <span className="bg-bg-2 text-fg-2 px-3 py-1 rounded-full text-sm font-medium">
                  2-4 weeks
                </span>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start">
                  ...
                  <span className="text-fg-2">FHIR architecture design and review</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Implementation guide selection</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Technical feasibility assessments</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Roadmap and milestone planning</span>
                </div>
              </div>
              <a
                href="https://calendar.app.google/TMvRGiiYfbBKNd889"
            ...
            <div className="bg-bg rounded-xl p-8 shadow-sm hover:shadow-lg transition border-2 border-primary-blue relative">
              ...
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-2xl font-bold text-fg">Implementation Partnership</h3>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Everything in Strategic Advisory</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Hands-on implementation support</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Code reviews and architecture guidance</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Weekly sprint planning and reviews</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Team training and knowledge transfer</span>
                </div>
              </div>
              <a
                href="https://calendar.app.google/TMvRGiiYfbBKNd889"
            ...
            <div className="bg-bg rounded-xl p-8 shadow-sm hover:shadow-lg transition">
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-2xl font-bold text-fg">Code Review & Audit</h3>
                <span className="bg-bg-2 text-fg-2 px-3 py-1 rounded-full text-sm font-medium">
                  1-2 weeks
                </span>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Comprehensive codebase review</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Architecture and pattern analysis</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Standards compliance verification</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Prioritized fix recommendations</span>
                </div>
              </div>
              <a
                href="https://calendar.app.google/TMvRGiiYfbBKNd889"
            ...
            <div className="bg-bg rounded-xl p-8 shadow-sm hover:shadow-lg transition">
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-2xl font-bold text-fg">Team Training</h3>
                <span className="bg-bg-2 text-fg-2 px-3 py-1 rounded-full text-sm font-medium">
                  2-5 days
                </span>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Custom curriculum for your use case</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Hands-on workshops with real examples</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Implementation guide deep dives</span>
                </div>
                <div className="flex items-start">
                  <span className="text-primary-green mr-2 mt-1">✓</span>
                  <span className="text-fg-2">Best practices and common pitfalls</span>
                </div>
              </div>
              <a
                href="https://calendar.app.google/TMvRGiiYfbBKNd889"
      ...
      <section className="py-16 bg-bg">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-fg">Who We Work With</h2>
            <p className="text-xl text-fg-2 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="bg-bg-2 p-6 rounded-xl text-center">
              <div className="text-4xl mb-4">🏥</div>
              <h3 className="font-bold text-lg mb-2 text-fg">Health Systems</h3>
            ...
            <div className="bg-bg-2 p-6 rounded-xl text-center">
              <div className="text-4xl mb-4">💳</div>
              <h3 className="font-bold text-lg mb-2 text-fg">Payer Organizations</h3>
              <p className="text-sm text-fg-2">
            ...
            <div className="bg-bg-2 p-6 rounded-xl text-center">
              <div className="text-4xl mb-4">🚀</div>
              <h3 className="font-bold text-lg mb-2 text-fg">Digital Health Startups</h3>
              <p className="text-sm text-fg-2">
            ...
            <div className="bg-bg-2 p-6 rounded-xl text-center">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="font-bold text-lg mb-2 text-fg">Analytics Platforms</h3>
              <p className="text-sm text-fg-2">
