...
export default function ProfilingGuide() {
  return (
    <div className="min-h-screen bg-bg-2">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <span className="ml-4 text-lg font-semibold text-fg-2">FHIR Profiling Guide</span>
            </div>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary-navy to-primary-blue text-fg py-16">
        <div className="max-w-7xl mx-auto px-4">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="bg-bg rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-3xl font-bold text-fg mb-6">Introduction to FHIR Profiling</h2>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-bg-2 border-l-4 border-primary-blue p-6 my-6">
              <h3 className="text-xl font-semibold text-fg mb-3">What is FHIR Profiling?</h3>
            ...
            <h3 className="text-2xl font-bold text-fg mt-8 mb-4">The Learn, Build, Use Framework</h3>
            <div className="grid md:grid-cols-3 gap-6 my-6">
              <div className="border-2 border-primary-blue rounded-lg p-6 bg-bg-2">
                <div className="text-3xl mb-3">📚</div>
                <h4 className="font-bold text-xl mb-2 text-primary-blue">LEARN</h4>
                <p className="text-fg-2">Understand FHIR specifications, implementation guides, and existing patterns</p>
              </div>
              <div className="border-2 border-accent-purple rounded-lg p-6 bg-bg-2">
                <div className="text-3xl mb-3">🔨</div>
                <h4 className="font-bold text-xl mb-2 text-accent-purple">BUILD</h4>
                <p className="text-fg-2">Design and create profiles that align with your business requirements</p>
              </div>
              <div className="border-2 border-primary-green rounded-lg p-6 bg-bg-2">
                <div className="text-3xl mb-3">🚀</div>
                <h4 className="font-bold text-xl mb-2 text-primary-green">USE</h4>
                <p className="text-fg-2">Implement, validate, and iterate on your profiles in production</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-bg rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            <h3 className="text-2xl font-bold text-fg mb-4">Step 1: Understanding FHIR Base Specifications</h3>
            ...
            <div className="border-l-4 border-primary-blue pl-6 mb-6">
              ...
              <pre className="bg-bg-2 text-fg p-4 rounded-lg overflow-x-auto text-sm">
...
// Practitioner - Healthcare professionals`}</code>
            ...
            <h3 className="text-2xl font-bold text-fg mb-4 mt-8">Step 2: Aligning Business Goals with FHIR</h3>

            <div className="bg-bg-2 border-l-4 border-line-2 p-6 mb-6">
              ...
              <div className="space-y-4 text-fg-2">
                <div>
                  ...
                  <p className="ml-4 text-sm italic text-fg-2">
            ...
            <h3 className="text-2xl font-bold text-fg mb-4 mt-8">Step 3: Research Implementation Guides</h3>
            ...
            <div className="bg-bg-2 border-l-4 border-primary-blue p-6">
              <h4 className="font-semibold mb-2">Research Checklist:</h4>
              <ul className="space-y-2 text-fg-2 text-sm">
        ...
        <section className="bg-bg rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            <h3 className="text-2xl font-bold text-fg mb-4">Step 4: Design Your Profile</h3>
            ...
            <div className="bg-bg-2 p-6 rounded-lg mb-6">
              ...
              <ol className="space-y-3 text-fg-2">
                <li>
            ...
            <h4 className="text-xl font-bold text-fg mb-3">Example: Lab Result Profile</h4>
            <p className="text-fg-2 mb-4">
    ...
    "element": [
      ...
      },
      {
        ...
        "mustSupport": true
            ...
            <h3 className="text-2xl font-bold text-fg mb-4 mt-8">Step 5: Define Extensions</h3>
...
// Usage in an Observation:
{
  ...
  // ... rest of observation
            ...
            <h3 className="text-2xl font-bold text-fg mb-4 mt-8">Step 6: Create Value Sets</h3>
    ...
    "include": [{
      ...
      "concept": [
        ...
        <section className="bg-bg rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            <h3 className="text-2xl font-bold text-fg mb-4">Step 7: Validation and Testing</h3>
            ...
            <div className="bg-bg-2 p-6 rounded-lg mb-6">
              ...
              <ol className="space-y-3 text-fg-2">
                <li>
                  ...
                  <pre className="bg-bg-2 text-fg p-3 rounded mt-2 text-sm overflow-x-auto">
  ...
  patient-example.json`}</code>
            ...
            <h4 className="text-xl font-bold text-fg mb-3">Example: Valid Lab Result</h4>
            <pre className="bg-bg-2 text-fg p-6 rounded-lg overflow-x-auto mb-6">
              <code>{`{
  "resourceType": "Observation",
    ...
    "type": {
      "coding": [{
        ...
        "display": "Normal Range"
            ...
            <h3 className="text-2xl font-bold text-fg mb-4 mt-8">Step 8: Implementation and Iteration</h3>
            ...
            <div className="border-l-4 border-primary-green pl-6 mb-6">
              ...
              <ul className="space-y-2 text-fg-2">
                <li>
                  ...
                  <p className="ml-4 text-sm text-fg-2">Use the FHIR IG Publisher to create browsable documentation</p>
                </li>
                <li>
                  <strong>□ Provide Example Resources</strong>
                  <p className="ml-4 text-sm text-fg-2">Include valid examples for each profile</p>
                </li>
                <li>
                  <strong>□ Document Conformance Expectations</strong>
                  <p className="ml-4 text-sm text-fg-2">Clear SHALL/SHOULD/MAY requirements</p>
                </li>
                <li>
                  <strong>□ Set Up a Test Server</strong>
                  <p className="ml-4 text-sm text-fg-2">Allow implementers to test against your profiles</p>
                </li>
                <li>
                  <strong>□ Gather Feedback</strong>
                  <p className="ml-4 text-sm text-fg-2">Iterate based on real-world implementation experience</p>
                </li>
                <li>
                  <strong>□ Version Your Profiles</strong>
                  <p className="ml-4 text-sm text-fg-2">Use semantic versioning to manage changes</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* Best Practices */}
        <section className="bg-bg rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-3xl font-bold text-fg mb-6">Best Practices Summary</h2>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="border-2 border-line-2 rounded-lg p-6 bg-bg-2">
              <h3 className="text-xl font-bold text-fg mb-4">✓ DO</h3>
              <ul className="space-y-3 text-fg-2 text-sm">
            ...
            <div className="border-2 border-line-2 rounded-lg p-6 bg-bg-2">
              <h3 className="text-xl font-bold text-fg mb-4">✗ DON&apos;T</h3>
              <ul className="space-y-3 text-fg-2 text-sm">
